              ...
              <div class="container-fluid flex-grow-1 container-p-y">
                ...
                <div class="row g-0 card" style="flex-direction: row;">
                      <div class="col-md-4">
                        ...
                        <a href="userPersonal" class="btn btn-outline-secondary">Volver</a>
                      </div>
                      </div>
                    ...
                    <form action="<?php echo SERVERURL; ?>conexiones/updatePersonal.php" enctype="multipart/form-data" method="POST" data-form="update" class="FormularioAjax">
                      ...
                      <div class="row">
                        <div class="col mb-3">
                          ...
                          <input type="text" name="cedula" id="cedula" class="form-control" autocapitalize="on" value="<?php echo $data->PersonalCedula; ?>" placeholder="Cambiar Cédula"/>
                        </div>
                      </div>
                      <div class="row mb-3">
                      ...
                      <div class="row">
                        ...
                        <div class="mb-1">
                          <div class="form-check">
                            <input class="form-check-input" onkeypress="return numeros(event)" value="No tiene teléfono" name="noTel"  value="" type="checkbox" id="noTelf" />
                      ...
                      <div class="row">
                        <div class="col mb-3">
                          ...
                          <input type="text" name="lugarNac" onkeypress="return letras(event)" class="form-control" autocapitalize="on" value="<?php echo $data->PersonalLugarNac; ?>" placeholder="Ingresar Lugar de Nacimiento" />
                        </div>
                      </div>
                      <div class="row">
                        <div class="col mb-3">
