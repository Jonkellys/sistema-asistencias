                      ...
                      <div class="mb-4">
                        <div class="mt-1">
                          <div class="list-group list-group-flush">
                            ...
                            <li class="list-group-item"><strong style="margin-right: 10px;">Usuario: </strong><?php echo $data->UserName; ?></li>
                            <li class="list-group-item"><strong style="margin-right: 10px;">Correo: </strong><?php echo $data->UserEmail; ?></li>
