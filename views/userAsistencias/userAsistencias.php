        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
                        ...
                        <?php
                          ...
                          while ($rows = $result->fetch()) {
                            ...
                            if($rows['AsistenciaSalida'] == "0000-00-00 00:00:00") {
                              $salida = "No hay registro de salida";
                              $marcar =  "<a href='userAsistencias?codigo=" . $rows['AsistenciaCodigo'] . "' class='btn btn-sm btn-info' data-bs-toggle='tooltip' data-bs-offset='0,4' data-bs-placement='top' data-bs-html='true' title='' data-bs-original-title='<span>Añadir Salida</span>'>
                                        <span class='tf-icons bx bx-log-out'></span>
                                      </a>";
                            } else {
                              $salida = date("h:i:s", $salidas);
                              $marcar = "";
                            }
            ...
            <?php
                ...
                if ($sql->execute()) {
                  echo '<script> window.location = "http://localhost/sistema-asistencias/userAsistencias"; </script>';
                } else {
